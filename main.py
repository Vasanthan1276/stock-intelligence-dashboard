...
def write_mu_signal(
    ...
    if (
        ...
        raise RuntimeError(
            "Refusing to write MU signal because the "
            f"price is invalid: {price!r}."
        )
    ...
    payload = {
        ...
        "price_usd": round(validated_price, 4),
        "scores": {
